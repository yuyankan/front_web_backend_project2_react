...
from config_minio import BUCKET_NAME,MINIO_ENDPOINT,ACCESS_KEY,SECRET_KEY
import numpy as np
import cv2
...
def load_yolo_image( object_name,bucket=BUCKET_NAME):
    """
...
def get_image_url_boto3(object_name,bucket_name=BUCKET_NAME,  expires=600):
    """
    使用 boto3 生成 presigned URL，expires 单位秒
    """
